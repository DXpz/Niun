...
const sampleOffers: Offer[] = [
  ...
  // SOYAPANGO
  { id: '65', title: 'Pizza Familiar 2 Toppings', description: 'Pizza familiar con 2 ingredientes a elegir + bebida 1.5L', originalPrice: 18.99, salePrice: 11.99, category: 'restaurantes', store: 'Pizza Hut Soyapango', address: 'Boulevard Central, Soyapango', expiresAt: '2024-03-15', verified: true, lat: 13.72, lng: -89.16, discount: 37, rating: 4.4, soldCount: 234 },
  { id: '66', title: 'Combo Pollo Frito 8 piezas', description: '8 piezas de pollo frito + papas fritas + salsa', originalPrice: 12.99, salePrice: 8.49, category: 'restaurantes', store: 'Pollos Brother Soyapango', address: 'Calle Principal, Soyapango', expiresAt: '2024-03-10', verified: true, lat: 13.715, lng: -89.165, discount: 35, rating: 4.6, soldCount: 456, isHot: true },
  { id: '67', title: 'Farmacia del Ahorro - Ibuprofeno 400mg', description: 'Antiinflamatorio ibuprofen 400mg 20 tabletas', originalPrice: 6.99, salePrice: 3.99, category: 'farmacia', store: 'Farmacia del Ahorro', address: 'Centro Comercial Soyapango', expiresAt: '2024-03-20', verified: true, lat: 13.718, lng: -89.158, discount: 43, rating: 4.5, soldCount: 789 },
  { id: '68', title: 'Supermercado Todo Precio - Aceite 1L', description: 'Aceite vegetal vegetal 1 litro', originalPrice: 4.50, salePrice: 2.79, category: 'supermercado', store: 'Supermercado Todo Precio', address: 'Colonia El Carmen, Soyapango', expiresAt: '2024-03-15', verified: true, lat: 13.722, lng: -89.162, discount: 38, rating: 4.2, soldCount: 234 },
  { id: '69', title: 'Audífonos Inalámbricos JBL 500', description: 'Audífonos JBL Tune 500BT inalámbricos bluetooth', originalPrice: 49.99, salePrice: 29.99, category: 'tecnologia', store: 'Tech Zone Soyapango', address: 'Boulevard del Pulguero, Soyapango', expiresAt: '2024-03-12', verified: true, lat: 13.716, lng: -89.157, discount: 40, rating: 4.6, soldCount: 167, isNew: true }
]
